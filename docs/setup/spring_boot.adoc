...
* DBコネクションプールを使用する場合、 https://spring.pleiades.io/spring-boot/docs/current/reference/html/application-properties.html#appendix.application-properties.data[Spring Boot標準のプロパティ] を使用します。
** プロパティ `spring.datasource.XXX` を使用して定義します。
