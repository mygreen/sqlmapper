...
import com.github.mygreen.sqlmapper.core.test.entity.meta.MTypeValueUtilDateTimeTestEntity;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(classes=H2TestConfig.class)
public class UtilDateTimeTest extends QueryTestSupport {
    ...
    void testAutoSelect_date() {
        ...
        MTypeValueUtilDateTimeTestEntity m_ = MTypeValueUtilDateTimeTestEntity.testUtilDateTime;

        TypeValueUtilDateTimeTestEntity result = sqlMapper.selectFrom(m_)
    ...
    void testAutoInsert() {
        ...
        TypeValueUtilDateTimeTestEntity entity = new TypeValueUtilDateTimeTestEntity();
        entity.setId(10);
    ...
    void testAutoUpdate() {
        ...
        TypeValueUtilDateTimeTestEntity entity = sqlMapper.selectFrom(m_)
                .id(1l)
                .getSingleResult();
